...
import img from "../assets/productDetailedPic.png";
import imgLarge from "../assets/productDetailedPic.png";
import img2 from "../assets/productDetailedPic.png";
import imgLarge2 from "../assets/productDetailedPic.png";
import img3 from "../assets/productDetailedPic.png";
import imgLarge3 from "../assets/productDetailedPic.png";
import img4 from "../assets/productDetailedPic.png";
import imgLarge4 from "../assets/productDetailedPic.png";
import img5 from "../assets/productDetailedPic.png";
import imgLarge5 from "../assets/productDetailedPic.png";
import HomeBG from "../assets/productDetailedPic.png";
        ...
        <div className="product__details__top__row">
          ...
          <div className="product__details__content">
            ...
            <div className="main__product__content__row">
              <Link to="/cart" className="main__product__content__row__text">
                Add to Cart
              </Link>
              <button className="flexibility__section__btn">Buy Now</button>
            </div>
          </div>
        </div>
      </div>
