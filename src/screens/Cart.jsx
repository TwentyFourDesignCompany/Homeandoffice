      ...
      <div className="cart__container__left__card__content">
        <div className="cart__container__left__card__content__left">
          <div className="cart__container__left__card__content__left__headings">
            Ballerina Chair
            <span>Color: Soft Pink/Red, Size: 10L</span>
          </div>
          <svg
            width="85"
            height="17"
      ...
      <div className="cart__container">
        ...
        <div className="cart__container__right">
          <div className="cart__container__right__header">
            <div className="cart__container__right__header__heading">
              Payment Methods
            </div>
            <div className="cart__container__right__header__row">
              <div class="radio__btn">
                <input id="id" name="radio" type="radio" />
                <label for="id" class="radio__btn__label">
                  Credit Card
                </label>
              </div>{" "}
              <div class="radio__btn">
                <input id="id2" name="radio" type="radio" />
                <label for="id2" class="radio__btn__label">
                  Paypal
                </label>
              </div>
            </div>
            ...
            <input
              ...
              className="cart__container__right__header__input"
            />
            <div className="cart__container__right__header__input__double">
              <input
                type="text"
          ...
          <div className="cart__container__right__bottom">
            ...
            <div className="cart__container__right__bottom__row">
              Order Total: <span> $ 82.28</span>
            </div>
            <button className="flexibility__section__btn">Purchase</button>
          </div>
        </div>
      </div>
    </>
